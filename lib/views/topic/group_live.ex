defmodule Bonfire.UI.Social.GroupLive do
      ...
      {:ok,
       assign(
         ...
         sidebar_widgets: [
           users: [
            secondary: [
              {Bonfire.UI.Topic.WidgetAboutLive, [title: "About topic x", about: "A sub for ALL parents, step parents, parents-to-be, guardians, caretakers, and anyone else who prefers to base their parenting choices on actual, evidence-backed scientific research.", date: "16 Feb"]},
