defmodule Bonfire.UI.Social.EditCircleLive do
  ...
  def update(assigns, socket) do
      ...
      followed = Bonfire.Social.Follows.list_followed(e(assigns, :current_user, nil)) #|> IO.inspect
      followers = Bonfire.Social.Follows.list_followers(e(assigns, :current_user, nil)) #|> IO.inspect
